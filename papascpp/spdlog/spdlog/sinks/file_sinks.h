...
public:
  explicit simple_file_sink(const filename_t& filename, bool force_flush = false) : _file_helper(force_flush) {
...
public:
  rotating_file_sink(const filename_t& base_filename, const filename_t& extension, std::size_t max_size,
                     std::size_t max_files, bool force_flush = false)
...
public:
  ...
  daily_file_sink(const filename_t& base_filename,
