...
public:
   ...
   */
  virtual void propagateOne(const Particle& ptc, const SurfaceCylinder& cyl) = 0;
...
protected:
   ...
   */
  virtual void propagateOne(const Particle& ptc, papas::Position layer, double cylinderz, double cylinderRadius) = 0;
};
