...
/// The PFBlcoks are seleced from the PapasEvent using the selected blocktype
...
/// Note: For any blocks that
/// are not simplified a copy of the original PFBlock is taken and placed in the simplified
...
private:
  ...
  Blocks& m_simplifiedBlocks;      ///< the blocks produced by the blocksplitter
