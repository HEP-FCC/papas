...
public:
   ...
   * @param[in] const VolumeCylinder&& volume : defines the element cylinders
  ...
  const VolumeCylinder& volumeCylinder() const { return m_volume; }  ///< return the volume cylinder
  Layer layer() const { return m_layer; };                           ///< returns kEcal, kHcal etc
  const Material& material() const { return m_material; }

protected:
  VolumeCylinder m_volume;  ///< The cylinders describing the detector element
