...
#define PAPASLOG_VERBOSE(x) \
  if (papaslog::logger()->doPrint(papaslog::Logging::VERBOSE)) papaslog::logger()->log(papaslog::Logging::VERBOSE) << x;
...
#define PAPASLOG_DEBUG(x) \
  if (papaslog::logger()->doPrint(papaslog::Logging::DEBUG)) papaslog::logger()->log(papaslog::Logging::DEBUG) << x;
...
#define PAPASLOG_INFO(x) \
  if (papaslog::logger()->doPrint(papaslog::Logging::INFO)) papaslog::logger()->log(papaslog::Logging::INFO) << x;
...
#define PAPASLOG_WARNING(x) \
  if (papaslog::logger()->doPrint(papaslog::Logging::WARNING)) papaslog::logger()->log(papaslog::Logging::WARNING) << x;
...
#define PAPASLOG_ERROR(x) \
  if (papaslog::logger()->doPrint(papaslog::Logging::ERROR)) papaslog::logger()->log(papaslog::Logging::ERROR) << x;
...
#define PAPASLOG_FATAL(x) \
  if (papaslog::logger()->doPrint(papaslog::Logging::FATAL)) papaslog::logger()->log(papaslog::Logging::FATAL) << x;
// clang-format on
