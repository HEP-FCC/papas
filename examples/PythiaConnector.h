...
public:
  ...
  void makePapasParticlesFromGeneratedParticles(
                                                const fcc::MCParticleCollection* ptcs, papas::Particles& particles);  ///< takes pythia particles and creates Papas type particles adding them into an empty Particles collection
