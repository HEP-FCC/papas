...
public:
  ...
  void addStraight(Path::Ptr path,const TVector3& tvec, int linestyle, int linecolor, int linewidth);
  void addHelix(Path::Ptr path, const TVector3& tvec, int linestyle, int linecolor);
